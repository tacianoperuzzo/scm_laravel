...
const corporacoes = [
    { id: 'PM', descricao: 'Polícia Militar' },
    { id: 'BM', descricao: 'Bombeiro Militar' },
]
...
const handleTransform = (data) => {
    ...
    data.pessoa.corporacao = _pessoa.value.corporacao
                    ...
                    <AccordionPanel value="2">
                        ...
                        <AccordionContent>
                            <div class="grid grid-cols-4 gap-4 mb-4 mt-4">
                                ...
                                <cInputUI :errors="errors" field="pessoa.corporacao">
                                    <FloatLabel variant="on">
                                        <Select v-model="_pessoa.corporacao" name="pessoa.corporacao"
                                            :options="corporacoes" optionLabel="descricao" optionValue="id" fluid />
                                        <label for="iCorporacao">Corporação</label>
                                    </FloatLabel>
                                </cInputUI>
